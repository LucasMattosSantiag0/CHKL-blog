...
<html lang="pt-br">
  <head>
    ...
    <title>CHKL-Alterar Conteúdo</title>
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs card-header-tabs">
        <li class="nav-item ">
          <a class="nav-link text-dark active" href="">Alterar Conteúdo</a>
        </li>
    ...
    <section class="ml-5" >
	<form method="POST" action="alterarp.php?id=<?= $id ?>" enctype="multipart/form-data">
  	<input type="hidden" name="size" value="1000000">
  	<div>
  	<label for="titulo" class="h3">Imagem de Capa</label><br>
	<input type="file" name="image" class="form-control border-dark " style="max-width:58%;">
  	</div>
 <label for="titulo" class="h3">Título da Matéria</label><br>
 <input type="text" class=" form-control border-dark" name="titulo" id="titulo" value="<?= $data['titulo']?>" style="max-width:58%;"> <br>
  	<div>
	
	 <label for="titulo" class="h3">Categoria</label><br>
	 <select name="categoria" class="form-control border-dark " style="max-width:58%;">
				<option value=""></option>
...
<p class="h3">Resumo</p>
	 ...
	 <textarea class="border-dark" id="parentEditor2"
      	...
      	rows="4" 
      	name="resumo" 
		maxlength = "301"><? echo $data['resumo']?></textarea>
	 ...
	 <textarea class="border-dark" id="parentEditor2"
      	...
      	cols="40" 
      	rows="10" 
      	name="image_text" > <? echo $data['image_text']?></textarea>
	  
	 
  	</div>
  	<div>
  		<button type="submit" name="upload" class=" ml-0	mt-5 mb-3 btn btn-block btn-outline-dark" style="max-width: 60%;">Alterar</button>
  	</div>
  </form>
