...
$id =  $_GET['id'];
	...
	$sql2 = " UPDATE images SET visitas = visitas + 1 WHERE id = $id";
...
?>
 ...
 ?>
  <div class="ml-5 mt-2 mr-2">
  <p class="h3">Faça seu comentário</p></div>
  <section class="ml-5 mb-4" >
 <form method="POST" action="comentar.php">
	<textarea class="border-dark" id="parentEditor2" rows="1" cols="5" name="nome" maxlength = "350" style="max-width: 20%;" 
	placeholder="Nome"></textarea><br><br>
	 <textarea class="border-dark" id="parentEditor2" rows="5" cols="5" name="comentario" maxlength = "350" style="max-width: 45%;" 
	 placeholder="Comentário"></textarea>
	<input type="hidden" value="<?php echo $id; ?>" name="id_post">
  </section>

  <div class="ml-5">
      <button type="submit" name="publicar" class="ml-4 mb-3 btn btn-block btn-outline-dark" style="max-width: 40%;">Publicar</button>
	  </form>
  </div>
