...
<html lang="pt-br">
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs card-header-tabs">
        <li class="nav-item ">
          <a class="nav-link text-dark" href="gerenciar_conteudo.php">Publicar Conteúdo</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark active" href="gerenciar_conteudo_editar.php">Editar/Excluir Conteúdo</a>
        </li>
    ...
    <section class="ml-5" >
      ...
      <br>
      <div class="tabela-cod" style="max-width:68%">
        <table class="table table-bordered tabela-mat ">
          <thead> 
            <tr >
              <th class="table-dark col-md-10 h4">Notícias</th>
  ...
  $result = mysqli_query($db, "SELECT * FROM images order by id desc");
    while ($row = mysqli_fetch_array($result)) {
	  ...
	  echo "<td><a href='./noticial.php?id=" .$row['id'] ."'> ".$row['titulo']." </a></td>";
	  echo "<td>
                
				<button  class='btn-outline-dark border rounded ml-2'  >
                  <a id='bot' href='./alterar_conteudo.php?id=" .$row['id'] ."' class='fas fa-pen'></a>
               </button>
                
				
                <button class='btn-outline-dark border rounded ml-2' onclick='delFunc(" .$row['id'] .")'>
                  <a id='bot' href='./deletarp.php?id=" .$row['id'] ."' class='fas fa-trash-alt' ></a>
                </button>
              </td>              ";
      echo "</tr>";
    }
