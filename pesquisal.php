...
if (isset($_POST['pesquisar'])) {
	...
	$pesquisa = mysqli_real_escape_string($db, $_POST['src']);
...
white-space: pre-wrap;       /* Since CSS 2.1 */
  ...
  <body class="home">
    ...
    <h1 class="mt-5 d-flex justify-content-center mb-0 ">Resultados da pesquisa: "<?php echo $pesquisa ?> "</h1>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 d-flex ml-5 ">
            ...
            <?php
			$db = mysqli_connect("localhost", "root", "usbw", "chkl");
  $teste = mysqli_query($db, "SELECT * FROM images WHERE titulo LIKE '%$pesquisa%' ORDER BY id desc");
